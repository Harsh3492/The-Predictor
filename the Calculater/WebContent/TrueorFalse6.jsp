...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">The Chinese government encourage 'selfies' on their own social networking site to help build their facial recognition database</p>
               </div>
							 <hr class="line">
						 
              <div class="form-group">
								<form class="" action="TrueorFalse7.jsp">
	 							<div class="row">
	 							  <div class="col-6">
