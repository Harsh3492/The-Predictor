...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">When a wombat dies,its children will instinctively start crying,even if they are thousands of miles away from their parent </p>
               </div>
							 <hr class="line">
						 
              <div class="form-group">
								<form class="" action="TrueorFalse4.jsp">
	 							<div class="row">
	 							  <div class="col-6">
