...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">If Russia were a sheet of paper,it would be able to wrap itself around the(sort of)planet,Pluto </p>
               </div>
							 <hr class="line">
						 
              <div class="form-group">
								<form class="" action="TrueorFalseCalculate.jsp">
	 							<div class="row">
	 							  <div class="col-6">
