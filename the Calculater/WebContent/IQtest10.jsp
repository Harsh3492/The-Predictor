...
if(selectedOption.equals("optionA"))
{
	count=0;
	answer="Wrong";
	pageContext.setAttribute("answer9", answer,PageContext.SESSION_SCOPE);
}
...
<div class="container-fluid">
              ...
              <div class="form-group">
								<form class="" action="IQtestCalculate.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionA" name="option"><img alt="Answer Img" class="img img-fluid" src="img/a1.JPG"></button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="optionB" name="option"><img alt="Answer Img" class="img img-fluid" src="img/a3.JPG"></button><br />
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionC" name="option"><img alt="Answer Img" class="img img-fluid" src="img/q3.JPG"></button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="optionD" name="option"><img alt="Answer Img" class="img img-fluid" src="img/a4.JPG"></button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId" value="optionE"  name="option"><img alt="Answer Img" class="img img-fluid" src="img/a5.JPG"></button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
