...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">The waitress gives you a glass of water instead of soda.You...</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="thinking7.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId " value="option1"  name="option">Yell at her and complain to the manager about bad service</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="option2"  name="option">Refuse it nicely and ask again for soda</button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId" value="option3"  name="option">Fine,she probably had a rough day</button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
