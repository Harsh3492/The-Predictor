...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">You feel overwhelmed and need to get stuff done.What are you thinking about?</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="thinking6.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId " value="option1"  name="option">I  hope everything will be fine soon</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="option2"  name="option">This is going to be a nightmare</button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId"value="option3"  name="option">Okay,it's not so bad.I can do it!</button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
