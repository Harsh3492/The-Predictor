...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">You took a test and you got 7 out of 10.What do you think?</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="thinking4.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId" value="option1"  name="option">This is not fair!</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId"  value="option2"  name="option">I tried my best,I'm kinda pleased with my score </button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId" value="option3"  name="option">A few question were hard,but it's okay,why more?</button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
