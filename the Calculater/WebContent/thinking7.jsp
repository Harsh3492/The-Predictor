...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">You've lost you wallet,or worse,it's beet stolen.What's your first thought?</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="thinking8.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId " value="option1"  name="option">Well,this sucks</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="option2"  name="option">From now on,I need to be more careful</button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId" value="option3"  name="option">Why does this always happen to me?</button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
