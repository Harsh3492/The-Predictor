...
if(selectedOption.equals("optionA"))
{
	count=0;
	answer="Wrong";
	pageContext.setAttribute("answer2", answer,PageContext.SESSION_SCOPE);
}
...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">If all Bloops are Razzies and all Razzies are Lazzies,all Bloops are definitely Lazzies?</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="IQtest4.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionA" name="option">True</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="optionB" name="option">False</button><br />
