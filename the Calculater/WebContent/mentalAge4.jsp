...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">You turn on TV and have to watch one of following,which do you choose?</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="mentalAge5.jsp">
	 							<div class="row"> 
	 							  <div class="col-sm-6">
	 							   <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionA" name="option">Documentary</button><br>
	 							   <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionB" name="option">Cartoons</button>
	 							  </div>
	 							  
	 							  <div class="col-sm-6 margin"  > 
	 							  <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionC" name="option">An action or comedy</button><br>
	 							  <button type="submit"  class="form-control  btn-outline-dark btnId" value="optionD" name="option">A drama or thriller</button>
	 							  </div>
	 							</div>
	 						 </form>
              </div>
