...
<body>
   	 ...
   	 <div class="modal-dialog modal-lg">
   	 	 <div class="modal-content" style="background-color:#29212100;">
               ...
               <hr class="line">
               <div class="text-center">
							  	<p class="qtxt">A good friend asks you for help with their homework.You...</p>
               </div>
							 <hr class="line">
              <div class="form-group">
								<form class="" action="thinking5.jsp">
	 							 <button type="submit"  class="form-control  btn-outline-dark btnId "value="option1"  name="option">Sure,what are friend for?</button><br />
	 							 <button type="submit" class="form-control btn-outline-dark btnId" value="option2"  name="option">Agree,but tell them not to get used to it.</button><br />
	 							 <button type="submit"  class="form-control btn-outline-dark btnId"value="option3"  name="option">No way!/Come up with a legit excuse</button>
	 						 </form>
              </div>
						 </div>
					 <!----------------------------------End of modal----------->
